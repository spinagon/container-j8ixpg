...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j8ixpg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j8ixpg.containers.anotherwebservice.com/
...
```
git clone git@github.com:spinagon/container-j8ixpg.git
cd container-j8ixpg
```
...
```
docker attach container-j8ixpg
```
